...
public class LobbyClientGUI {
	...
	public static String UserName= "Van";
	...
	public static void Connect(){
		try{
			final int PORT=555;
			final String HOST="ClueLess Host";
	...
	public static void BuildMainWindow(){
		MainWindow.setTitle(UserName + "'s Game Lobby");
	...
	public static void ConfigureMainWindow(){
		...
		String [] TestNames={"Ben", "Chris", "Paul", "Van", "Pat?"};
